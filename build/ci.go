...
import (
	...
	"github.com/lifefile/LFT/crypto/signify"
	"github.com/lifefile/LFT/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.lifefile", "-v", "github.com/lifefile/LFT/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/lifefile/LFT/mobile")
